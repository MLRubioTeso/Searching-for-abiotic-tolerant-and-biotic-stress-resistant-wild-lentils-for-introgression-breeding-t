...
#Order according to trait value: subset ordered according to the variable of our choice creating an index 
#(Ar = aridity, variable = Annual De Martonne Index; 
#Sa = salinity, variable = topsoil salinity (conductivity); 
#Wa = waterlogging, variable = Soil Texture).
